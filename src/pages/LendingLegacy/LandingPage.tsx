...
export default function LandingPage({
  ...
  return (
    ...
    >
      <DialogPolice open={openPolice0} setOpen={setOpenPolice0} type={0} />
      <DialogPolice open={openPolice1} setOpen={setOpenPolice1} type={1} />
        ...
        <main className="main">
          ...
          <section className="main_section">
            ...
            <div className="container">
              ...
              <LinkToTop className="main_section-banner">
                <img
            ...
            <div className="container">
              ...
              <div className="steps_section-title_wrap">
                <h2 className="steps_section-title">
                  <b className="raleway">Talent Q:</b> 6 шагов к успеху
                </h2>
                <h2 className="steps_section-title">
                  <b className="raleway">Talent Q:</b> 6 шагов к успеху
                </h2>
                ...
                <div className="video_block-content_wrapper">
                  ...
                  <div className="video_block-bar">
                    ...
                    <div className="video_block-item">
                      ...
                      <p>
                        Как успевать{" "}
                        <span className="nowrap">в отведенное</span> время?
                      </p>
                    </div>
                    ...
                    <div className="video_block-item">
                      ...
                      <p>
                        Что читать сначала:{" "}
                        <span className="nowrap">текст или</span> вопрос?
                      </p>
                    </div>
            ...
            <div className="test_block">
              ...
              <div className="container">
                ...
                <div className="test_block-desc">
                  ...
                  <p>
                    Наши и реальные тесты идентичны по сложности, тематике и
                    формату вопросов.
                  </p>
              ...
              <div className="container">
                ...
                <div className="situation_block-container">
                  <LinkToTop className="situation_block-item">
                    <span></span>
                    <p>
                      Ноутбук начал <b>перезагружаться</b> прямо посреди теста
                    </p>
                    <LazyComponent2
                      src={CMac1}
                      className={"display_content video_mac"}
                    />
                  </LinkToTop>
                  ...
                  <LinkToTop className="situation_block-item">
                    <span></span>
                    <p>
                      <b>Оборвалось интернет соединение</b> в самый
                  ...
                  <LinkToTop className="situation_block-item">
                    <span></span>
                    <p>
                      Загрузился вопрос, <br /> <b>но не загрузилась таблица</b>
                    </p>
                    <img src={CMac4} />
                  </LinkToTop>
                </div>
            ...
            <div className="container">
              <div className="evacuation_block-wrap">
                <div className="evacuation_block-content">
                  <h2>Без паники!</h2>
                  <p>У нас есть план эвакуации из любой проблемной ситуации.</p>
            ...
            <div className="metrix">
              <div className="container">
                <div className="metrix-content">
                  ...
                  <p>
                    По результатам наших тестов вы получите отчёты, идентичные
                    тем, что получает работодатель после реального теста.{" "}
                  </p>
                  <p>
                    Это поможет вам оценить собственные силы в глазах будущего
                    босса.
                  </p>
                  <LazyComponent
                    src={MobileGrafic}
            ...
            <div className="exclusive">
              <div className="container">
                <LinkToTop className="exclusive-mac">
                  <img className="exclusive-mac-bg lazy" src={ExMac} />
                  <img
                    src={ExMac1}
                ...
                <div className="exclusive-content">
                  ...
                  <h2>
                    ...
                    <span className="nowrap">и прокторинг</span>
                  </h2>
                  <p>
                    Иногда работодатели устанавливают{" "}
                    <span className="nowrap">за кандидатами</span>{" "}
                    роботизированное наблюдение или просят пройти{" "}
                    <span className="nowrap">повторное тестирование.</span>
                  </p>
                  <p>
                    Узнайте, что именно отслеживает система. Опробуйте
                    верификацию и прокторинг{" "}
                    <span className="nowrap">на нашей</span> платформе!
                  </p>
                  <img src={Number5} className="exclusive-number lazy" />
              ...
              <div className="container">
                <div className="novelty-content">
                  ...
                  <p>
                    ...
                    <span className="nowrap">и ответьте</span> на несколько
                    вопросов. <br />
                    Наш алгоритм определит систему тестирования, сформирует курс
                    и укажет цену.
                  </p>
                ...
                <div className="how_block-flex">
                  ...
                  >
                    <div className="how_block-item_content">
                      ...
                      <p>
                        ...
                        <b className="nowrap">и вставьте</b> в специальное окно
                        текст письма о назначении тестов.{" "}
                      </p>
                      <p>
                        Наш алгоритм определит, действительно ли у вас Talent Q,
                        чтобы вы зря не тратили деньги. Затем система сформирует
                  ...
                  <div className="how_block-item">
                    <div className="how_block-item_active-content">
                      ...
                      <p>
                        Войдите на платформу, используя код из СМС. Процедура
                        займёт <br />
                        не больше минуты.
                      </p>
                  ...
                  >
                    <div className="how_block-item_content">
                      ...
                      <p>
                        Выберите удобный способ онлайн-оплаты и не беспокойтесь:
                        соединение защищено!{" "}
                      </p>
